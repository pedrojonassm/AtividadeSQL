...
update semnome.departamento set gerente = 2 where nome = "dep2";
update semnome.departamento set gerente = 3 where nome = "dep3";
update semnome.departamento set gerente = 4 where nome = "dep4";
update semnome.departamento set gerente = 5 where nome = "dep5";
